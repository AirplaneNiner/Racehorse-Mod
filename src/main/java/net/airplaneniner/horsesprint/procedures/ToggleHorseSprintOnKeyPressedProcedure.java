...
public class ToggleHorseSprintOnKeyPressedProcedure {
    public static void execute(Entity entity) {
        ...
        if ((entity.getVehicle()) instanceof HorseGeneticEntity) {
            ...
            if (((entity.getVehicle()) instanceof LivingEntity _livingEntity10 && _livingEntity10.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_SPURT_COOLDOWN.get())
                    ? Objects.requireNonNull(_livingEntity10.getAttribute(HorseSprintModAttributes.HORSE_SPURT_COOLDOWN.get())).getBaseValue()
                    : 0) != 0) {
                {
                    entity.getCapability(HorseSprintModVariables.PLAYER_VARIABLES).ifPresent(capability -> {
