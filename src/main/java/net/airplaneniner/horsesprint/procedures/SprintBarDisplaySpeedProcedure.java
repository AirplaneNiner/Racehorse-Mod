	...
	public static String execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(HorseSprintModItems.SPEEDOMETER.get()))) {
			return "Speed: " + (new java.text.DecimalFormat("##.##")
					.format(((entity.getVehicle()) instanceof LivingEntity _livingEntity2 && _livingEntity2.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED) ? _livingEntity2.getAttribute(Attributes.MOVEMENT_SPEED).getValue() : 0) * 43.17));
		}
		return "";
	}
