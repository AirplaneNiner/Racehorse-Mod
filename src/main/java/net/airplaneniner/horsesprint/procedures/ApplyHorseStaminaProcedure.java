	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity instanceof HorseGeneticEntity) {
            ...
            if ((entity instanceof LivingEntity _livingEntity1 && _livingEntity1.getAttributes().hasAttribute(Attributes.JUMP_STRENGTH) ? _livingEntity1.getAttribute(Attributes.JUMP_STRENGTH).getBaseValue() : 0) <= 0.55) {
                if (entity instanceof LivingEntity _livingEntity3 && _livingEntity3.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_SPURT.get()))
                    _livingEntity3.getAttribute(HorseSprintModAttributes.HORSE_SPURT.get()).setBaseValue((Mth.nextDouble(RandomSource.create(), 0.05875, 0.07)));
                ...
                if (entity instanceof LivingEntity _livingEntity7 && _livingEntity7.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_SPURT.get()))
                    _livingEntity7.getAttribute(HorseSprintModAttributes.HORSE_SPURT.get()).setBaseValue((Mth.nextDouble(RandomSource.create(), 0.07, 0.1)));
                ...
                if (entity instanceof LivingEntity _livingEntity11 && _livingEntity11.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_SPURT.get()))
                    _livingEntity11.getAttribute(HorseSprintModAttributes.HORSE_SPURT.get()).setBaseValue((Mth.nextDouble(RandomSource.create(), 0.1, 0.125)));
                ...
                if (entity instanceof LivingEntity _livingEntity14 && _livingEntity14.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_SPURT.get()))
                    _livingEntity14.getAttribute(HorseSprintModAttributes.HORSE_SPURT.get()).setBaseValue((Mth.nextDouble(RandomSource.create(), 0.125, 0.16875)));
            }

            // Apply spurt modifier
            // This is based off the HP of the horse
            if (entity instanceof LivingEntity _livingEntity16 && _livingEntity16.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_STAMINA.get()))
                _livingEntity16.getAttribute(HorseSprintModAttributes.HORSE_STAMINA.get())
            ...
            if ((entity instanceof LivingEntity _livingEntity15 && _livingEntity15.getAttributes().hasAttribute(Attributes.MOVEMENT_SPEED) ? _livingEntity15.getAttribute(Attributes.MOVEMENT_SPEED).getBaseValue() : 0) <= 0.2) {
                if (entity instanceof LivingEntity _livingEntity18 && _livingEntity18.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get()))
                    _livingEntity18.getAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get())
                            .setBaseValue(Math.ceil((entity instanceof LivingEntity _livingEntity16 && _livingEntity16.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_STAMINA.get())
                                    ? _livingEntity16.getAttribute(HorseSprintModAttributes.HORSE_STAMINA.get()).getBaseValue()
                ...
                if (entity instanceof LivingEntity _livingEntity23 && _livingEntity23.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get()))
                    _livingEntity23.getAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get())
                            .setBaseValue(Math.ceil((entity instanceof LivingEntity _livingEntity21 && _livingEntity21.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_STAMINA.get())
                                    ? _livingEntity21.getAttribute(HorseSprintModAttributes.HORSE_STAMINA.get()).getBaseValue()
                ...
                if (entity instanceof LivingEntity _livingEntity28 && _livingEntity28.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get()))
                    _livingEntity28.getAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get())
                            .setBaseValue(Math.ceil((entity instanceof LivingEntity _livingEntity26 && _livingEntity26.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_STAMINA.get())
                                    ? _livingEntity26.getAttribute(HorseSprintModAttributes.HORSE_STAMINA.get()).getBaseValue()
                ...
                if (entity instanceof LivingEntity _livingEntity32 && _livingEntity32.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get()))
                    _livingEntity32.getAttribute(HorseSprintModAttributes.HORSE_MAX_SPURT_TIMER.get())
                            .setBaseValue(Math.ceil((entity instanceof LivingEntity _livingEntity30 && _livingEntity30.getAttributes().hasAttribute(HorseSprintModAttributes.HORSE_STAMINA.get())
                                    ? _livingEntity30.getAttribute(HorseSprintModAttributes.HORSE_STAMINA.get()).getBaseValue()
