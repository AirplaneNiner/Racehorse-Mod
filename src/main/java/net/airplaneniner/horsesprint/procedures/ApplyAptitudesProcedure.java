    ...
    public static void execute(Entity entity) {
        ...
        if ((entity instanceof LivingEntity _livingEntity0 && _livingEntity0.getAttributes().hasAttribute(Attributes.JUMP_STRENGTH) ? Objects.requireNonNull(_livingEntity0.getAttribute(Attributes.JUMP_STRENGTH)).getBaseValue() : 0) < 0.6) {
            if (entity instanceof LivingEntity _livingEntity2 && _livingEntity2.getAttributes().hasAttribute(HorseSprintModAttributes.DIST_APT.get()))
                Objects.requireNonNull(_livingEntity2.getAttribute(HorseSprintModAttributes.DIST_APT.get())).setBaseValue((200 / Mth.nextDouble(RandomSource.create(), 0.3, 0.4)));
            ...
            if (entity instanceof LivingEntity _livingEntity6 && _livingEntity6.getAttributes().hasAttribute(HorseSprintModAttributes.DIST_APT.get()))
                Objects.requireNonNull(_livingEntity6.getAttribute(HorseSprintModAttributes.DIST_APT.get())).setBaseValue((200 / Mth.nextDouble(RandomSource.create(), 0.25, 0.35)));
            ...
            if (entity instanceof LivingEntity _livingEntity13 && _livingEntity13.getAttributes().hasAttribute(HorseSprintModAttributes.DIST_APT.get()))
                Objects.requireNonNull(_livingEntity13.getAttribute(HorseSprintModAttributes.DIST_APT.get())).setBaseValue((200 / Mth.nextDouble(RandomSource.create(), 0.14, 0.25)));
        }
        if (Math.floor(((entity instanceof LivingEntity _livingEntity14 && _livingEntity14.getAttributes().hasAttribute(Attributes.JUMP_STRENGTH) ? Objects.requireNonNull(_livingEntity14.getAttribute(Attributes.JUMP_STRENGTH)).getBaseValue() : 0) * 100) % 5) == 1) {
            ...
            if (entity instanceof LivingEntity _livingEntity16 && _livingEntity16.getAttributes().hasAttribute(HorseSprintModAttributes.TRACK_APT.get()))
                Objects.requireNonNull(_livingEntity16.getAttribute(HorseSprintModAttributes.TRACK_APT.get())).setBaseValue(0);
        }
        if (entity instanceof LivingEntity _livingEntity18 && _livingEntity18.getAttributes().hasAttribute(HorseSprintModAttributes.DIST_APT.get()))
