...
import net.airplaneniner.horsesprint.procedures.*;
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        ...
        if (SprintBarDisplayOverlayIngameProcedure.execute(entity)) {
            ...
            event.getGuiGraphics().drawString(Minecraft.getInstance().font,
                    ...
                    ReturnWhipCountProcedure.execute(entity), w / 2 - 185, h / 2, -1, false);
            event.getGuiGraphics().drawString(Minecraft.getInstance().font,

                    ReturnDistRemainingProcedure.execute(entity), w / 2 - 185, h / 2 + 12, -1, false);
        }
    }
}