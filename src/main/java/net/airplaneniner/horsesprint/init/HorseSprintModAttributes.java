...
public class HorseSprintModAttributes {
	...
	public static final RegistryObject<Attribute> HORSE_SPURT = REGISTRY.register("horse_stamina", () -> new RangedAttribute("attribute.horse_sprint.horse_stamina", 0.05875, 0.05875, 0.16875).setSyncable(true));
	public static final RegistryObject<Attribute> HORSE_STAMINA = REGISTRY.register("horse_spurt", () -> new RangedAttribute("attribute.horse_sprint.horse_spurt", 0.4, 0.4, 1).setSyncable(true));
